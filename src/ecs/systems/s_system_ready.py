...
def system_ready_level(world: esper.World,delta_time:float,start_game_info:dict,screen:pygame.Surface):
    ...
    for _, (c_rl) in components: 
        ...
        if c_rl.time >= c_rl.time_to_ready:
            ...
            text_surf, text_rect = text_objects(start_game_info["text"], largeText,start_game_info) 
            ...
            world.add_component(ready_message,CTransform(pygame.Vector2(screen.get_rect().h/2-text_surf.get_rect().h/2 , screen.get_rect().w/2)))
